...
public class CameraColorFilter extends CameraFilter {
    ...
    public CameraColorFilter(Context context, InputStream inputStream) {
        super(context);
        ...
        mToneCurveTextureId = ShaderUtil.createTexture(GLES20.GL_TEXTURE_2D);
    }

    @Override
    protected int createProgram(Context applicationContext) {
        return ShaderUtil.createProgram(applicationContext, R.raw.vertex_shader, R.raw.fragment_shader_ext_tone_curve);
    }
    ...
    protected void getGLSLValues() {
        ...
        muToneCurveTextureLoc = GLES20.glGetUniformLocation(mProgramID, "toneCurveTexture");
    }
