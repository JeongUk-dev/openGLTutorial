...
public class CameraUtil {
    ...
    public static void setCameraDisplayOrientation(Activity activity, Camera camera, int cameraID, Camera.Parameters parameters) {
        Camera.CameraInfo info = new Camera.CameraInfo();
        Camera.getCameraInfo(cameraID, info);
        final int deviceOrientation = Degrees.getDisplayRotation(activity);
        int mDisplayOrientation = Degrees.getDisplayOrientation(info.orientation, deviceOrientation, info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT);
        Log.d("CameraFragment", String.format("Orientations: Sensor = %d˚, Device = %d˚, Display = %d˚", info.orientation, deviceOrientation, mDisplayOrientation));
    ...
    public static Camera.Size chooseOptimalSize(List<Camera.Size> previewSizes, int w, int h) {
